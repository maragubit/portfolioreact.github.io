...
function Luces(){
    ...
    const [isKeyOn, setIsKeyOn] = useState(Cookies.get('key')|| '');
    

    useEffect(() => {
        const intervalo = setInterval(() => {
        setLuz(Cookies.get('luz') || '');
        setLuminol(Cookies.get('luminol') || '');
        setIsKeyOn(Cookies.get('key') || '');
        }, 1000);
