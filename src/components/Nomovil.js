...
function Nomovil(){
  ...
  const [imagen,setImagen]=useState(luz);
    ...
    Swal.fire({
      ...
      text: 'Para ver los menús del portafolio',
      icon: 'question',
      ...
      if (result.isConfirmed) {
        Cookies.set('uv', 'on', { expires: 7 });
        setImagen('sinluz1luminol.png');
        Swal.fire('Hecho', 'Modo rápido activado.', 'success');
      }
    });
  };
    ...
    return (
        <div className="portada">
          ...
          <div className="dash">
            <img id='imagen' className='soga' src="/soga.png" alt="cuerda" onClick={()=>fast()} height="591px" ></img>
            <div className="align">
